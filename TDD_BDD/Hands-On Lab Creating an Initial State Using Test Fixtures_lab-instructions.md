...
![Nose tests](https://cf-courses-data.s3.us.cloud-object-storage.appdomain.cloud/IBM-CD0241EN-SkillsNetwork/labs/module2/images/03_step3_nose.png "Nose tests")
...
![All passing](https://cf-courses-data.s3.us.cloud-object-storage.appdomain.cloud/IBM-CD0241EN-SkillsNetwork/labs/module2/images/03_step5_nose.png "All passing")
...
| 2023-12-22 | 1.1 | K Sundararajan | Updated instructions using Python3.8 for `nosetests` |
| 2023-12-26 | 1.2 | K Sundararajan | Updated instructions to work correctly with `Python3.8` |
| 2024-01-03 | 1.3 | Rofrano | Reverted back to 1.1 to remove uneeded code fixes |
|   |   |   |   | -->
