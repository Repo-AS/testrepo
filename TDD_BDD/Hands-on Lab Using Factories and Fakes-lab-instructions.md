...
```
duwjx-tdd_bdd_PracticeCode/labs/05_factories_and_fakes
```
...
![Nosetests output](https://cf-courses-data.s3.us.cloud-object-storage.appdomain.cloud/IBM-CD0241EN-SkillsNetwork/labs/module3/images/05_step1_nosetests.png "Nosetests output")
...
| 2023-12-22 | 1.2  | K Sundararajan  | Updated instructions based on Python 3.8  |
| 2024-01-02 | 1.3 | K Sundararajan	| Updated instructions for resolving Working outside of application context.. and Invalid isoformat string:.. errors |
| 2024-01-03 | 1.4 | Rofrano | Reverted to 1.2 and fixed corrupt strings |
|   |   |   |   | -->
